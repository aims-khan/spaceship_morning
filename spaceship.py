...
pygame.display.set_caption("Spaceship Female")
WHITE = (255,255,255)
BLACK = (0,0,0)
YELLOW = (255, 255, 0)
RED = (255, 0, 0)
...
HEALTH_FONT = pygame.font.SysFont('conicsans', 40)
...
def draw_winner(text):
    ...
    WIN.blit(draw_text, (WIDTH/2 - dra_text.get_width()/2, HEIGHT/2 - draw_text.get_height()/2))
    pygame.display.update()
